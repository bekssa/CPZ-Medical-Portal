  ...
  return (
    <div className="bg-[var(--bg)] min-h-screen">
      <div className="max-w-4xl mx-auto px-4 py-10">
        <nav className="text-sm text-[var(--text-muted)] mb-6 flex items-center gap-2 flex-wrap">
          ...
          <span>/</span>
          <span className="text-[var(--text-primary)] line-clamp-1">Государственный Герб Республики Казахстан</span>
        </nav>
	...
	<meta itemprop="inLanguage" content="ru-RU">
		...
		<h2 itemprop="headline">
			Государственный Герб Республики Казахстан		</h2>
							</div>
