  ...
  return (
    <div className="bg-[var(--bg)] min-h-screen">
      <div className="max-w-4xl mx-auto px-4 py-10">
        <nav className="text-sm text-[var(--text-muted)] mb-6 flex items-center gap-2 flex-wrap">
          ...
          <span>/</span>
          <span className="text-[var(--text-primary)] line-clamp-1">Мемлекеттік Әнұран Республики Казахстан</span>
        </nav>
        ...
        <article className="bg-white rounded-2xl border border-[var(--border)] p-6 md:p-8 shadow-sm">
          <h1 className="text-2xl md:text-3xl font-bold text-[var(--text-primary)] mb-8 pb-4 border-b border-[var(--border-light)] leading-snug">
            Мемлекеттік Әнұран Республики Казахстан
          </h1>
	...
	<meta itemprop="inLanguage" content="ru-RU">
		...
		<h2 itemprop="headline">
			Мемлекеттік Әнұран Республики Казахстан		</h2>
							</div>
...
<div ><img src="../../../almatyzdrav.kz/bitrix/templates/almatyzdrav_template/images/gimnKZ.html" alt="" border="0" height="663" vspace="0" width="500" /></div>
