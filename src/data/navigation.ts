...
const baseNavigation: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: 'Аналитический обзор', href: '/about/analytics' },
      {
        title: 'Государственные закупки',
        href: '/about/procurement',
        children: [
          { title: 'Объявления госзакупок', href: '/about/procurement/announcements' },
          { title: 'Протоколы вскрытия', href: '/about/procurement/opening-protocols' },
          { title: 'Протоколы итогов', href: '/about/procurement/results-protocols' },
        ],
      },
    ],
  },
  {
    ...
    children: [
      ...
      { title: 'Вопрос-ответ', href: '/patients/qa' },
  ...
  },
  {
    ...
    href: '/services',
    children: [
      { title: 'Реестр государственных услуг', href: '/services/registry' },
  ...
  },
  {
    ...
    href: '/links',
    children: [
      { title: 'История центра', href: '/links/history' },
      { title: 'Блог Директора', href: '/links/director-blog' },
      { title: 'Биография Директора', href: '/links/director-bio' },
      { title: 'Бесплатные и льготные лекарства', href: '/links/free-medicines' },
      { title: 'Гарантированный объем медицинской помощи', href: '/links/guaranteed-care' },
      { title: 'Финансовая отчетность', href: '/links/financial-reports' },
    ],
  },
  {
    title: 'Контакты',
...
const baseNavigationKz: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: 'Аналитикалық шолу', href: '/about/analytics' },
      {
        title: 'Мемлекеттік сатып алулар',
        href: '/about/procurement',
        children: [
          { title: 'Мемлекеттік сатып алулар хабарландырулары', href: '/about/procurement/announcements' },
          { title: 'Ашу хаттамалары', href: '/about/procurement/opening-protocols' },
          { title: 'Қорытынды хаттамалар', href: '/about/procurement/results-protocols' },
        ],
      },
    ],
  },
  {
    ...
    children: [
      ...
      { title: 'Сұрақ-жауап', href: '/patients/qa' },
  ...
  },
  {
    ...
    href: '/services',
    children: [
      { title: 'Мемлекеттік қызметтер тізілімі', href: '/services/registry' },
  ...
  },
  {
    ...
    href: '/links',
    children: [
      { title: 'Орталық тарихы', href: '/links/history' },
      { title: 'Директор блогы', href: '/links/director-blog' },
      { title: 'Директор өмірбаяны', href: '/links/director-bio' },
      { title: 'Тегін және жеңілдікті дәрілер', href: '/links/free-medicines' },
      { title: 'Кепілдендірілген медициналық көмек', href: '/links/guaranteed-care' },
      { title: 'Қаржылық есептілік', href: '/links/financial-reports' },
    ],
  },
  {
    title: 'Байланыстар',
